...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
    ...
    const sessdata = config.SESSION_ID.replace("E3_HACKER-MD~", '');
    try {
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there E3_HACKER-MD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet E3_HACKER-MD WhatsApp Bot.\n\n *Thanks for using E3_HACKER-MD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029VajnN629RZAbp8aZAa1E \n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/waqa827/E3_HACKER-MD\n\n> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ E3_HACKER-MD Official ❣️ \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/t0sryn.png` }, caption: up })
  }
  })
